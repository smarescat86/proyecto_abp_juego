...
$lang = array(
    ...
    "marketing" => "Marketing",
    "descripcionMarketing" => "- Grado medio en actividades comerciales <br>
    - Grado superior en marketing y publicidad<br>
    - Grado superior es gestion de ventas y espacios comerciales<br>
    - Grado superior en comercio internacional",

    "turismo" => "Turismo",
    "descripcionTurismo" => "- Grado superior en agencias de viajes y gestion",
