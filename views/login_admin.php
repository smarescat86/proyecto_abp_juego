                    ...
                    <form action="../controllers/loginController.php" method="POST" id="form-admin">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input id="txtPassword" type="Password" id="pass-admin" name="pass-admin"class="form-control" placeholder="Password" >
                        ...
                        <div class="d-grid">
                            <button type="submit" id="login-admin" name="login-admin" class="btn btn-dark">Login</button>
                        </div>
                    </form>
                </div>
            </div>
